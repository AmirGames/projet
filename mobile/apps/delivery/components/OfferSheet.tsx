...
const styles = themedStyles(() => ({
  ...
  tagMain: { backgroundColor: COLORS.success, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6 },
  tagMainText: { color: '#fff', fontWeight: '700', fontSize: 14 },
  tagSoft: { backgroundColor: COLORS.successBg, borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6 },
  tagSoftText: { color: COLORS.successOnBg, fontWeight: '700', fontSize: 14 },
  ...
  acceptFill: { position: 'absolute', left: 0, top: 0, bottom: 0, backgroundColor: '#1E7E3E' },
