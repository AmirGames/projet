    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">{t('productCount', { count: products.length })}</p>
        </div>
        <Link
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-hidden">
        <table className="w-full">
          <thead className="bg-gray-700/50 border-b border-gray-700">
            <tr>
              <th className="px-6 py-3 text-left text-sm font-semibold">{t('nameColumn')}</th>
              <th className="px-6 py-3 text-left text-sm font-semibold">{t('priceColumn')}</th>
              <th className="px-6 py-3 text-left text-sm font-semibold">{t('statusColumn')}</th>
              <th className="px-6 py-3 text-left text-sm font-semibold">{t('dateColumn')}</th>
              <th className="px-6 py-3 text-right text-sm font-semibold">{t('actionsColumn')}</th>
            </tr>
          </thead>
